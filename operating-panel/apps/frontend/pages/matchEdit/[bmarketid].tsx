...
const MatchEditPage: React.FC = () => {
  ...
  useEffect(() => {
    // Set initial data immediately to avoid loading state
    if (bmarketid) {
      setMatchData({
        matchName: 'Gulbarga Mystics v Hubli Tigers',
        seriesName: 'Maharaja Trophy KSCA T20',
        scoreIframe: 'https://score.trovetown.co/socket-iframe-5/crickexpo/34633501',
        scoreIframe2: 'https://card.hr08bets.in/ap/getScoreData?event_id=34633501',
        eventId: '34633501',
        seriesId: '12267948',
        sportId: '4',
        marketId: '1.246774940',
        priority: '',
        matchDate: '18-08-2025 19:15:00',
        tvId: '',
        socketUrl: 'https://vigcache.trovetown.co/',
        cacheUrl: 'https://vigcache.trovetown.co/v2/api/oddsDataNew?market_id=1.246774940',
        otherMarketCacheUrl: 'https://vigcache.trovetown.co/v2/api/dataByEventId?eventId=34633501',
        tvUrl: 'https://cache.bpexchanges.com/embed?eventId=34633501',
        matchType: 'T-20',
        status: 'UPCOMING',
        betDelayTime: '',
        bookmakerRange: '',
    ...
    // Set fetching to false after a short delay to ensure data is loaded
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex space-x-2 items-start">
                        <input
                          ...
                          className="flex-1 border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                        <div className="h-16 w-32 rounded border border-gray-300 bg-gray-100 flex items-center justify-center text-xs text-gray-500">
                          {matchData.team2Img ? 'Image' : 'No Image'}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex space-x-2 items-start">
                        ...
                        />
                        <div className="h-16 w-32 rounded border border-gray-300 bg-gray-100 flex items-center justify-center text-xs text-gray-500">
                          {matchData.team1Img ? 'Image' : 'No Image'}
                        </div>
                      </div>
                    </div>
